...
const Formulario = ({crearCita}) =>{
    ...
    //Cuando el usuario presiona agreagr cita
    ...
    const submitCita = e =>{
        ...
        //Asignar un ID
        cita.id = uuidv4(); //aca creamos un id
    ...
    return (
        <Fragment>
            ...
            <form onSubmit={submitCita}>
                ...
                {/* <label>Hora</label>
                <input type="time" name="time" className="u-full-width" onChange={actualizarState} value={hora}/> */}
